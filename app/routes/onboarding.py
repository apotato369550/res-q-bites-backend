...
async def onboard_establishment(
    ...
    current_user.establishment_name = payload.establishment_name
    current_user.establishment_type = payload.establishment_type
    current_user.establishment_address = payload.address
    if payload.phone is not None:
        current_user.phone = payload.phone
